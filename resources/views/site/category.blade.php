    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-4">
          <div class="entry2">
            <a href="{{route('single-blog', $post->id)}}"><img style="height: 200px; width:200px;"  src="{{$post->gallery->image}}" alt="Image" class="img-fluid rounded"></a>
            <div class="excerpt">
            <span class="post-category text-white bg-secondary mb-3">{{$post->category->name}}</span>

            <h2 style="height:150px !important"><a href="{{route('single-blog', $post->id)}}" >{{$post->title}}</a></h2>
